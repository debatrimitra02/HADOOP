...
if [ "$#" -ne 2 ]; then
    echo "Illegal number of parameters. Expected 3 parameters."
...
## Data Cleanup
hadoop fs -rm -r /user/dkari/output-*
hadoop fs -rmr /user/dkari/centroids.dat
...
.jar:/home/dkari/high-scale-lib-1.1.1.jar
...
# Data Ingestion
# java -cp /home/dkari/KMeansClusteringMR-0.0.1.jar com.slb.analytics.hbase.ExportCsv $1
java -cp /home/dkari/KMeansClusteringMR-0.0.1-jar-with-dependencies.jar com.slb.analytics.hbase.ExportCsv $1

# Run KMeans Algorithm on data loaded in previous step
hadoop jar /home/dkari/KMeansClusteringMR-0.0.1.jar com.slb.analytics.kmeans.KMeans --libjars ${LIBJARS} /user/dkari/ /user/dkari/output $2
